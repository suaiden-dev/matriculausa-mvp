...
serve(async (req) => {
  ...
  try {
    console.log('📤 upload-identity-photo: Processing request');
    ...
    if (uploadError) {
      console.error('❌ upload-identity-photo: Storage upload error:', uploadError);
      return new Response(
    ...
    console.log('✅ upload-identity-photo: File uploaded successfully:', filePath);
