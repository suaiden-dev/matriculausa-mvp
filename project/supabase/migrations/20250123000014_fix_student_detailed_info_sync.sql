-- Migration: Fix get_student_detailed_info function data sync
-- This fixes the Application Fee and Documents Status inconsistencies

-- Drop and recreate the function with proper data synchronization
...
BEGIN
  ...
  SELECT 
    ...
    COALESCE(schi.documents_status, sp.documents_status, 'pending') as documents_status,
