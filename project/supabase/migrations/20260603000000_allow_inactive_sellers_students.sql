-- Migration: allow_inactive_sellers_students
-- Description: Update get_affiliate_admin_profiles_with_fees to return students from inactive/deactivated sellers so historical commissions/tracking remain visible.
