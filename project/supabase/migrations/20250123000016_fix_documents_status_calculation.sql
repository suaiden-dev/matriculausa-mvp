-- Migration: Fix documents_status calculation to be dynamic
-- This calculates the documents_status based on individual document statuses instead of hardcoded values

-- Drop and recreate the function with dynamic documents_status calculation
