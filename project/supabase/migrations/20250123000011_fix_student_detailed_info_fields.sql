-- Migration: Fix get_student_detailed_info function fields
-- This removes fields that don't exist in the user_profiles table
...
BEGIN
  ...
  SELECT 
    ...
    'Not specified' as student_process_type,
