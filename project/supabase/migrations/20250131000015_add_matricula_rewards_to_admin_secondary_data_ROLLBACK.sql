-- ROLLBACK Migration: Remove Matricula Rewards referral info from get_admin_student_secondary_data
-- Description: Reverte a adição de informações do Matricula Rewards, restaurando a função para o estado anterior
-- Use este arquivo caso a migration 20250131000015_add_matricula_rewards_to_admin_secondary_data.sql cause problemas
...
BEGIN
  ...
  -- Construir resultado consolidado (SEM matricula_rewards_info)
  SELECT jsonb_build_object(
...
-- Comentário explicativo restaurado
