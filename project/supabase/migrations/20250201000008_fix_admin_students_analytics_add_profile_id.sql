-- Migration: Fix get_admin_students_analytics to include profile_id
-- This adds the missing profile_id field that is needed for the I-20 deadline calculation

-- Drop and recreate the function with profile_id
...
-- Add comment
COMMENT ON FUNCTION get_admin_students_analytics(uuid) IS 'Returns student analytics for affiliate admin dashboard with profile_id and payment flags';
