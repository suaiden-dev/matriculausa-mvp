-- Migration: Add student details to get_affiliate_admin_profiles_with_fees RPC
-- Adiciona full_name, email e created_at aos dados retornados
...
-- Update comment
COMMENT ON FUNCTION get_affiliate_admin_profiles_with_fees(uuid) IS 'Returns affiliate admin profiles with correct fee flags calculated from ALL scholarship applications. Includes student details (full_name, email, created_at).';