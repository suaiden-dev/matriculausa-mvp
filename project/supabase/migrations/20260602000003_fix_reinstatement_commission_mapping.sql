-- Migration: fix_reinstatement_commission_mapping
-- Description: Add missing fee type mappings in register_payment_billing (reinstatement_fee and application) to ensure correct commission calculation.
...
BEGIN
  ...
  normalized_fee_key := CASE fee_type_param
    ...
    WHEN 'reinstatement_fee'     THEN 'reinstatement'
