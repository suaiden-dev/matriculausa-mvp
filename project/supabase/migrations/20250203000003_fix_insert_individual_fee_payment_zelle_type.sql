-- Migration: Fix insert_individual_fee_payment function - zelle_payment_id type
-- Description: Corrige o tipo do parâmetro p_zelle_payment_id de text para uuid para corresponder à coluna da tabela

-- Atualizar função RPC insert_individual_fee_payment para usar uuid no zelle_payment_id
