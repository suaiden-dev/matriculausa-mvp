-- Migration: Add source to get_admin_student_full_details RPC
-- Purpose: Include the source field in the consolidated student details RPC for the admin dashboard.
