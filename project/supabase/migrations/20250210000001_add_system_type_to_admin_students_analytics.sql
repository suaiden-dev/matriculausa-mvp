-- Migration: Add system_type to get_admin_students_analytics function
-- This allows the affiliate admin dashboard to display correct fees based on system type

-- Drop existing function
DROP FUNCTION IF EXISTS get_admin_students_analytics(uuid);

-- Recreate function with system_type
...
-- Add comment
COMMENT ON FUNCTION get_admin_students_analytics(uuid) IS 'Returns student analytics for affiliate admin dashboard with DYNAMIC FEES from packages and system_type for correct fee calculation';
