-- FIX: get_admin_users_data() was missing 'role' in RETURNS TABLE and SELECT
-- This caused all users to appear as 'student' in UserManagement (frontend fallback)
...
BEGIN
  ...
  IF NOT is_admin() AND NOT is_post_sales() THEN
