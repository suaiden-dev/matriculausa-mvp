-- Migration: Add transfer_proof_to_school fields to get_admin_student_full_details RPC
-- Purpose: Include the new proof columns in the admin student details function so
--          TransferFormSection.tsx can display the student's proof upload.

DROP FUNCTION IF EXISTS get_admin_student_full_details(uuid);
      ...
      (
        SELECT jsonb_agg(
          jsonb_build_object(
            ...
            'transfer_proof_to_school_url', sa.transfer_proof_to_school_url,
            'transfer_proof_to_school_at', sa.transfer_proof_to_school_at,
            'transfer_proof_to_school_status', sa.transfer_proof_to_school_status,
