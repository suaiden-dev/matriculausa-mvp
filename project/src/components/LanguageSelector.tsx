...
const LanguageSelector: React.FC<LanguageSelectorProps> = ({ 
  ...
  const buttonClasses = {
    ...
    dashboard: "inline-flex items-center px-3 py-2 text-sm font-medium rounded-xl text-slate-600 hover:text-slate-900 bg-white hover:bg-slate-100 transition-colors border border-slate-200 hover:border-slate-300"
  };
