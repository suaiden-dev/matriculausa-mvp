      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            ...
            <Link to="/eb3-jobs" className="text-slate-700 hover:text-[#05294E] transition-colors font-medium relative group flex items-center">
              Vagas EB-3
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#05294E] group-hover:w-full transition-all duration-300"></span>
            </Link>
      ...
      {isMenuOpen && (
        <div className="lg:hidden bg-white/95 backdrop-blur-lg border-t border-slate-200/50">
          <div className="px-4 pt-4 pb-6 space-y-2">
            ...
            <Link to="/eb3-jobs" className="block px-4 py-3 text-slate-700 hover:bg-[#05294E]/5 rounded-xl font-medium transition-all duration-200" onClick={() => setIsMenuOpen(false)}>Vagas EB-3</Link>
