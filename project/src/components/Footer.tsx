        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-10 md:gap-12">
          ...
          <div className="space-y-6 col-start-1 lg:col-auto">
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/pre-qualification" className="text-slate-600 hover:text-[#05294E] transition-colors hover:translate-x-1 transform duration-200 block">{t('footer.students.preQualification')}</Link></li>
