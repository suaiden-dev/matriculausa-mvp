      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
            <div className="w-16 h-16 bg-yellow-300/20 rounded-2xl flex items-center justify-center mb-6 mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center">
          <button 
            ...
            className="group bg-yellow-300 text-slate-900 px-10 py-5 rounded-2xl text-xl font-black hover:bg-yellow-200 transition-all duration-300 transform hover:scale-105 shadow-2xl flex items-center justify-center"
          >
