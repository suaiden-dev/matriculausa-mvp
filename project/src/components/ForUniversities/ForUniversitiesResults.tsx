    ...
    <section className="py-24 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-16">
          <div className="bg-white rounded-3xl p-8 border border-slate-200 text-center shadow-sm hover:shadow-lg transition-all duration-300">
            <div className="text-4xl font-black text-[#05294E] mb-2">85%</div>
            <div className="text-slate-600 font-semibold">Average Acceptance Rate</div>
          </div>
          <div className="bg-white rounded-3xl p-8 border border-slate-200 text-center shadow-sm hover:shadow-lg transition-all duration-300">
            <div className="text-4xl font-black text-[#D0151C] mb-2">3.2x</div>
            <div className="text-slate-600 font-semibold">Faster Processing</div>
          </div>
          <div className="bg-white rounded-3xl p-8 border border-slate-200 text-center shadow-sm hover:shadow-lg transition-all duration-300">
            <div className="text-4xl font-black text-[#05294E] mb-2">92%</div>
            <div className="text-slate-600 font-semibold">Student Satisfaction</div>
          </div>
          <div className="bg-white rounded-3xl p-8 border border-slate-200 text-center shadow-sm hover:shadow-lg transition-all duration-300">
            <div className="text-4xl font-black text-[#D0151C] mb-2">45%</div>
            <div className="text-slate-600 font-semibold">Cost Reduction</div>
          </div>
        </div>
