            ...
            <div className="flex-1">
              ...
              <div className="flex space-x-2">
                <button
                  onClick={connectMicrosoft}
                  disabled={loading}
                  className="px-3 py-1 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
                >
