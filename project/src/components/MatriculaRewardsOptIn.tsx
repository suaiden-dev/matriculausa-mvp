      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center">
          ...
          <div className="space-y-4">
            ...
            <a
              href={`https://wa.me/${import.meta.env.VITE_WHATSAPP_NUMBER}?text=Hello%2C%20I%20have%20questions%20about%20the%20Matricula%20Rewards%20program%20for%20universities`}
              target="_blank"
