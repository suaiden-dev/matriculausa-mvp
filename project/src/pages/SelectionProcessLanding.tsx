...
const scholarshipsData = [
    {
      ...
      modality: "Presencial",
      workAuth: ["CPT", "OPT"],
      originalPrice: "U$ 12.250/semestre",
      discountedPrice: "U$ 4.250/semestre",
    ...
    },
    {
      ...
      modality: "Presencial",
      workAuth: ["CPT", "OPT"],
      originalPrice: "U$ 13.000/semestre",
      discountedPrice: "U$ 4.900/semestre",
    ...
    },
    {
      ...
      modality: "Presencial",
      workAuth: ["CPT", "OPT"],
      originalPrice: "U$ 14.250/semestre",
      discountedPrice: "U$ 5.600/semestre",
    ...
    },
    {
      ...
      modality: "Híbrido",
      workAuth: ["CPT", "OPT"],
      originalPrice: "U$ 5.000/semestre",
      discountedPrice: "U$ 2.100/semestre",
    ...
    },
    {
      ...
      modality: "Híbrido",
      workAuth: ["CPT", "OPT"],
      originalPrice: "U$ 12.075/semestre",
      discountedPrice: "U$ 8.575/semestre",
    ...
    },
    {
      ...
      modality: "Híbrido",
      workAuth: ["CPT", "OPT"],
      originalPrice: "U$ 3.000/semestre",
      discountedPrice: "U$ 2.100/semestre",
      monthlyPrice: "U$ 350/mês",
    ...
    },
    {
      ...
      modality: "Híbrido",
      workAuth: ["CPT", "OPT"],
      originalPrice: "U$ 4.000/semestre",
      discountedPrice: "U$ 2.500/semestre",
    ...
    },
    {
      ...
      workAuth: ["CPT", "OPT"],
      originalPrice: "U$ 5.000/semestre",
      discountedPrice: "U$ 2.250/semestre",
    ...
    },
    {
      ...
      modality: "Híbrido",
      workAuth: ["CPT", "OPT"],
      originalPrice: "U$ 7.500/semestre",
      discountedPrice: "U$ 2.100/semestre",
      monthlyPrice: "U$ 350/mês",
