  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const registerData = {
        ...
        dependents: formData.dependents || 0, // Garantir que seja número
        scholarship_package_number: packageNumber,
        desired_scholarship_range: finalDesiredRange // Sempre definir um valor
      };
