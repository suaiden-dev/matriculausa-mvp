  ...
  return (
    <div className="bg-white">
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-slate-50 via-blue-50 to-slate-50 opacity-50"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-6">
              Start Your <span className="text-[#D0151C]">Selection Process</span> Today
            </h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto mb-8">
              Our comprehensive selection process helps international students navigate the complexities of applying to American universities.
            </p>
            
            <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-8 max-w-4xl mx-auto relative z-10">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center">
                  <div className="bg-[#D0151C] w-12 h-12 rounded-xl flex items-center justify-center shadow-lg mr-4">
                    <CreditCard className="h-6 w-6 text-white" />
                  </div>
                  <div>
                    <h3 className="text-2xl font-bold text-slate-900">Selection Process</h3>
                    <p className="text-slate-600">Complete application process for international students</p>
                  </div>
                </div>
                <div className="text-3xl font-black text-[#D0151C]">$350</div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                ...
                <div className="flex items-center bg-slate-50 p-4 rounded-xl">
                  <CheckCircle className="h-5 w-5 text-green-600 mr-3 flex-shrink-0" />
                  <span className="text-slate-700">Application guidance</span>
                </div>
                <div className="flex items-center bg-slate-50 p-4 rounded-xl">
                  <CheckCircle className="h-5 w-5 text-green-600 mr-3 flex-shrink-0" />
              ...
              <div className="flex justify-center">
                {isAuthenticated && !hasPaidProcess && !subscriptionLoading ? (
                  ...
                  <Link
                    to="/student/dashboard"
                    className="bg-green-600 text-white px-8 py-4 rounded-xl hover:bg-green-700 transition-all duration-300 font-bold flex items-center justify-center"
                  >
                  ...
                  <Link
                    to="/register"
                    className="bg-[#D0151C] text-white px-8 py-4 rounded-xl hover:bg-[#B01218] transition-all duration-300 font-bold flex items-center justify-center"
                  >
