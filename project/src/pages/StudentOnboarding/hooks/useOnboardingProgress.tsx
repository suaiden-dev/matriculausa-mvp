...
const VALID_STEPS: OnboardingStep[] = [
  ...
  'payment', 'ambassador_program', 'scholarship_fee', 'placement_fee', 'reinstatement_fee', 'my_applications', 'completed'
];
...
export const useOnboardingProgress = () => {
  ...
  const checkProgress = useCallback(async (force: boolean = false): Promise<OnboardingStep | null> => {
    ...
    try {
      ...
      else if (!freshProfile.rewards_popup_shown_at && !placementFeePaid && !scholarshipFeePaid && !reinstatementFeePaid) maxAllowedStep = 'ambassador_program';
