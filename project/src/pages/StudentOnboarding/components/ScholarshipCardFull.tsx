...
export const ScholarshipCardFull: React.FC<ScholarshipCardFullProps> = ({
  ...
  return (
    <div
      className={`group relative bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border-2 ${
        isSelected 
      ...
      <div className="p-4 flex flex-col">
        ...
        <div className="mb-3">
          <div className="flex items-start justify-between gap-2 mb-2">
            <h3 className="text-base font-bold text-slate-900 leading-tight line-clamp-2 flex-1">
              {scholarship.title}
            </h3>
            {isSelected && (
          ...
          <div className="flex items-center gap-2 flex-wrap">
            {scholarship.is_highlighted && (
              <span className="bg-gradient-to-r from-yellow-400 to-orange-500 text-white px-2 py-0.5 rounded text-xs font-bold flex items-center">
        ...
        <div className="flex items-center text-slate-600 text-sm mb-3">
          <Building className="h-4 w-4 mr-1.5 text-[#05294E] flex-shrink-0" />
        ...
        <button
          ...
          className="flex items-center justify-center gap-1 text-xs text-blue-600 hover:text-blue-700 font-medium mb-3 py-1"
        >
          {isExpanded ? (
            <>
              <span>{t('studentDashboard.findScholarships.scholarshipCard.showLess') || 'Show Less Details'}</span>
        ...
        {/* Expanded Content */}
        {isExpanded && (
          <div className="mb-3 pt-3 border-t border-slate-200 space-y-3">
            {/* Program Details */}
