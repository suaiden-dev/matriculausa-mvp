        ...
        <div className="w-full">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            <div className="max-w-full mx-auto">
              ...
              <div className="bg-slate-50 px-4 sm:px-6 lg:px-8 py-6 flex flex-col md:flex-row items-center md:items-center justify-between gap-4 border-b border-slate-200 text-center md:text-left">
                        ...
                        >
                          ...
                          <div className="text-xs space-y-1 bg-slate-50 p-2.5 rounded-lg">
                            <p className="text-slate-500 font-medium truncate">
                              <span className="text-slate-400 font-normal">Course:</span> {(app as any).scholarships?.field_of_study || 'N/A'}
                            </p>
                            <p className="text-slate-500 font-medium truncate">
                              <span className="text-slate-400 font-normal">Scholarship:</span> {(app as any).scholarships?.title || 'Unknown Scholarship'}
                            </p>
                          </div>
                          ...
                          <div className="flex justify-end pt-1">
                            <button
                              ...
                              className="inline-flex items-center px-3 py-1.5 border border-slate-200 rounded-lg text-xs font-medium text-slate-700 bg-white hover:bg-slate-50 hover:text-[#05294E] hover:border-[#05294E] transition-all shadow-sm"
