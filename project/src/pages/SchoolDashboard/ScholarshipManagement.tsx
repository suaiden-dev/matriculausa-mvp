                    ...
                    <div className="p-6 pb-4 flex-1 flex flex-col">
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex-1">
                          ...
                          <div className="flex items-center space-x-3">
                            <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${scholarship.is_active
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex justify-between items-center p-4 bg-purple-50 rounded-xl border border-purple-200">
                            <span className="text-purple-700 font-medium">Placement Fee</span>
                            <span className="font-bold text-lg text-purple-900 flex flex-col items-end">
                              {formatCurrency(getPlacementFee(Number(selectedScholarship.annual_value_with_scholarship ?? 0), selectedScholarship.placement_fee_amount))}
                              {selectedScholarship.placement_fee_amount ? (
                                <span className="text-xs font-normal text-purple-600 mt-0.5">Custom Rate</span>
                              ) : (
                                <span className="text-xs font-normal text-purple-600 mt-0.5">Standard Rate</span>
                              )}
                            </span>
                          </div>
                        </div>
