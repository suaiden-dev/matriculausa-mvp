...
const StudentDetails: React.FC = () => {
  ...
  return (
    <div className="p-4 md:p-6 bg-slate-50 min-h-screen">
      ...
      {activeTab === 'chat' && (
        <div className="bg-white p-12 rounded-2xl shadow-lg min-h-[650px] flex flex-col justify-between gap-8">
          <h2 className="text-2xl font-bold text-[#05294E] mb-6">Chat</h2>
          <div className="flex-1 overflow-y-auto min-h-[400px] pb-8 flex flex-col gap-6">
