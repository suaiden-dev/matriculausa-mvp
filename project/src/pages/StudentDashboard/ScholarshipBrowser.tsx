                    ...
                    <div className="p-4 sm:p-6 flex-1 flex flex-col">
                      ...
                      <div className="mt-auto">
                        <button
                          ...
                          className="w-full h-12 px-6 rounded-2xl font-bold text-sm flex items-center justify-center bg-gradient-to-r from-blue-500 to-blue-600 text-white hover:from-blue-600 hover:to-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:ring-offset-2"
                          title="View scholarship details"
                          aria-label="View scholarship details"
                        >
                          <span className="mr-2">{t('studentDashboard.findScholarships.scholarshipCard.show')}</span>
                          <span>{t('studentDashboard.findScholarships.scholarshipCard.details')}</span>
                        </button>
                      </div>
                  </div>
                </motion.div>
