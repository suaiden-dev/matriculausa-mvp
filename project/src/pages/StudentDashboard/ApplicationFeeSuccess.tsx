    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-red-50 px-4">
        <div className="bg-white rounded-2xl shadow-lg p-10 max-w-md w-full flex flex-col items-center">
          ...
          <h1 className="text-3xl font-bold text-red-700 mb-2">Application Fee Payment Error</h1>
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-green-50 px-4">
      <div className="bg-white rounded-2xl shadow-lg p-10 max-w-md w-full flex flex-col items-center">
        ...
        <p className="text-slate-700 mb-6 text-center">
          Your application has been processed and is under review. You will receive updates by email.
        </p>
