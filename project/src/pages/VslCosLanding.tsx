...
const VslCosLanding: React.FC = () => {
  return (
    <div className="relative min-h-screen bg-slate-950 font-sans text-slate-100 selection:bg-rose-500/30 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 pointer-events-none overflow-hidden bg-slate-950 h-screen">
        {/* Alterando as cores de glow para um tom diferente (ex: Rose/Purple) para diferenciar da Transfer */}
        <div className="absolute top-[-10%] right-[-5%] w-[600px] h-[600px] bg-rose-600/20 rounded-full blur-[120px]"></div>
      ...
      {/* Hero Content (COS - Troca de Status) */}
      <section className="relative pt-6 pb-16 px-4 z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            <span className="text-rose-400 font-bold uppercase tracking-[0.2em] text-sm md:text-md mb-4 block">
              ESTUDANTES COS (CHANGE OF STATUS)
            </span>
            <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold tracking-tight mb-8 leading-[1.1] text-transparent bg-clip-text bg-gradient-to-r from-white via-rose-50 to-indigo-100">
              Transforme seu visto de Turista <br className="hidden md:block" /> em um Futuro Legal nos EUA.
            </h1>
            <p className="text-lg md:text-xl text-rose-100/80 mb-12 max-w-3xl mx-auto font-light leading-relaxed">
          ...
          <motion.div
            ...
            className="mt-12 relative w-full aspect-video mx-auto max-w-4xl rounded-2xl md:rounded-[2rem] overflow-hidden shadow-[0_0_50px_rgba(225,29,72,0.2)] border border-white/10 bg-slate-900 group"
          >
            {/* Placeholder de vídeo simulando o player VSL */}
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              <div className="w-20 h-20 bg-rose-600/30 group-hover:bg-rose-600/50 transition-colors rounded-full flex items-center justify-center cursor-pointer shadow-[0_0_30px_rgba(225,29,72,0.3)] mb-4">
      ...
      <section id="checkout-section" className="relative z-20 w-full bg-slate-950 mt-10">
        <div className="text-center pb-8">
          ...
          <div className="w-16 h-1 bg-gradient-to-r from-rose-500 to-indigo-500 rounded-full mx-auto"></div>
        </div>
