            ...
            try {
              ...
              if (!extraError && extraProfile) {
                s = {
                  ...
                  is_application_fee_paid: s.is_application_fee_paid || extraProfile.is_application_fee_paid,
                  identity_photo_path:
        ...
        const { data, error: queryError } = await supabase
          ...
          .select(`
            ...
            scholarship_applications (
              ...
              transfer_proof_to_school_url,
              transfer_proof_to_school_status,
              transfer_proof_to_school_at,
              student_process_type,
              payment_status,
              reviewed_at,
              reviewed_by,
